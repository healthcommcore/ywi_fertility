...
sourcerer_insertText = function()
{
	// define variables used in function
	var spans, regex;
	var keepcolors = $( 'keepcolors' );
	var keepindent = $( 'keepindent' );
